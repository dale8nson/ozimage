...
export const PostsSkeleton = () => {
  ...
  return (
    <div className={`grid max-h-82.25 justify-center max-w-370 items-start grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-1.5 gap-y-1.5 h-fit w-full py-8 m-auto`}>
